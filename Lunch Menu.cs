...
class Lunch_Menu
{
    ...
    {
        string[] oldMenu = LunchItems();
        decimal[] oldPrices = LunchPrices();
        ...
        File.WriteAllText(@"C:\Users\Kiosk Records\Menus and Prices\Lunch Prices.txt", prices);
        File.WriteAllText(@"C:\Users\Kiosk Records\Menus and Prices\Lunch Items.txt", items);
    }
    public static void RemoveFromMenu(string itemName)
    {
        int location = Menu.FindInMenu(itemName, "Lunch");
        if (location == -1)
        {
    ...
    {
        string text = File.ReadAllText(@"C:\Users\Kiosk Records\Menus and Prices\Lunch Items.txt");
        string[] items = text.Split("-");
        
        return items;
    }
    public static decimal[] LunchPrices()
    {
        string text = File.ReadAllText(@"C:\Users\Kiosk Records\Menus and Prices\Lunch Prices.txt");
        string[] items = text.Split("-");
    ...
    {
        string[] items = LunchItems();
        decimal[] prices = LunchPrices();
